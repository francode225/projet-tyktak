...
INSERT INTO `gdcae26` VALUES ('AO190','manager d\'equipe','0000-00-00','2024-03-30',4,5,'licence','Informatique','Ecrivain','gerer des equipes','CDI'),('AO348','chef d\'entrerprises','0000-00-00','2024-03-30',2,3,'Master','Gestionnaire','Ecrivain','gerer l\'entreprise','CDD'),('AO291','cecefe','0000-00-00','2024-03-30',4,4,'bac','Gestionnaire','Developpeur','dkzdz','CDI');
...
--
-- Table structure for table `gdcme`
--

DROP TABLE IF EXISTS `gdcme`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gdcme` (
...
--
-- Dumping data for table `gdcme`
--

LOCK TABLES `gdcme` WRITE;
/*!40000 ALTER TABLE `gdcme` DISABLE KEYS */;
INSERT INTO `gdcme` VALUES (1,'czdz','2024-03-22 09:05:02','dxzz',0),(2,'dzc','2024-03-22 09:05:02','',0);
/*!40000 ALTER TABLE `gdcme` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-23  8:05:12
